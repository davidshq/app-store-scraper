 ...
 */
function validateRequired (opts, requiredFields, message) {
 ...
 */
function validateEither (opts, field1, field2, message) {
 ...
 */
function validateEnum (opts, field, validValues, message) {
 ...
 */
function validateRange (opts, field, min, max, message) {
  if (opts[field]) {
    if (opts[field] < min) {

...
[App Store Scraper API](../../../modules.md) / [lib/error-types](../README.md) / SearchError

# Class: SearchError

Defined in: [lib/error-types.ts:260](https://github.com/facundoolano/app-store-scraper/blob/7e1baf8350e9d5936df88e03bdbb2e2ecea26d48/lib/error-types.ts#L260)
...
> **new SearchError**(`message`, `code`, `originalError`?, `params`?): `SearchError`

Defined in: [lib/error-types.ts:261](https://github.com/facundoolano/app-store-scraper/blob/7e1baf8350e9d5936df88e03bdbb2e2ecea26d48/lib/error-types.ts#L261)
